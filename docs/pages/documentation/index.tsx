    ...
    <>
      ...
      <main>
        ...
        <div>
          ...
          <p>
            The way React Dumb Form works is by utilizing a DOM <code>{"<form />"}</code> node. We attach React event
          ...
          <p>
            ...
            <a href="https://github.com/deniskabana/react-dumb-form/blob/main/src/useDumbForm.tsx" target="_blank">
              source code of <code>useDumbForm.tsx</code> in our GitHub repo
            </a>
            .
          </p>
        </div>
