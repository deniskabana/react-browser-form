  ...
  return (
    <>
      ...
      <main>
        ...
        <p>
          React Dumb Form provides a <strong>minimal, but powerful</strong> first class API for helping with validation
          and data and/or type transformations.
        </p>
        ...
        <div>
          ...
          <p>
            ...
            as powerful as using complex schemas. The error you throw with <code>ValidationError</code> will be used as
            error message.
          </p>
