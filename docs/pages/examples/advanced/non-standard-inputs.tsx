...
export default function Page({ sourceCode }: { sourceCode: string }) {
  return (
    <>
      <Head>
        <title>Non-standard inputs example - React Browser Form Docs</title>
      </Head>
      ...
      <main>
        ...
        <p className="text-muted">
          ...
          <strong>you can handle any case with React Browser Form</strong>. Also, you will not miss out on the built-in
