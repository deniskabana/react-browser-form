...
export default function Page() {
  return (
    <>
      <Head>
        <title>Examples - React Browser Form Docs</title>
      </Head>
      ...
      <main>
        ...
        <p>
          React Browser Form aims to provide a lot of examples to showcase every feature and options there is to use.
